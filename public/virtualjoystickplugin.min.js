!(function (t, e) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    ? define(e)
    : ((t = 'undefined' != typeof globalThis ? globalThis : t || self).rexvirtualjoystickplugin = e());
})(this, function () {
  'use strict';
  function h(t, e) {
  ...
  var u = Phaser.Input.Keyboard.Key,
        ...
        t(e, [
          {
            key: 'shutdown',
            value: function () {
              for (var t in this.cursorKeys) this.cursorKeys[t].destroy();
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              return (
                i.enabled &&
                  (e && (this.noKeyDown = !1),
                  i.isDown !== e && ((y.timeStamp = Date.now()), (y.keyCode = i.keyCode), e ? i.onDown(y) : i.onUp(y))),
                this
              );
            },
          },
          {
            ...
            value: function () {
              for (var t in ((this.noKeyDown = !0), this.cursorKeys)) this.setKeyState(t, !1);
              return this;
            },
          },
          {
    ...
    y = { timeStamp: 0, keyCode: 0, altKey: !1, ctrlKey: !1, shiftKey: !1, metaKey: !1, location: 0 },
    f = 180 / Math.PI,
    v = { 'up&down': 0, 'left&right': 1, '4dir': 2, '8dir': 3 },
    d = {},
    p = Phaser.Utils.Objects.GetValue,
    m = Phaser.Math.Distance.Between,
    b = Phaser.Math.Angle.Between,
    w = (function () {
      s(r, e);
      var n = c(r);
      function r(t, e) {
        var i;
        return h(this, r), (i = n.call(this, t)).resetFromJSON(e), i;
      }
      return (
        t(r, [
          {
          ...
          },
          {
            key: 'setMode',
            value: function (t) {
              return 'string' == typeof t && (t = v[t]), (this.dirMode = t), this;
            },
          },
          {
            key: 'enable',
            ...
            set: function (t) {
              if (this._enable !== t) return t || this.clearVector(), (this._enable = t), this;
            },
          },
          {
            key: 'setEnable',
                ...
                switch (
                  ...
                  case 3:
                    22.5 < t && t <= 67.5
                      ...
                      : 247.5 < t && t <= 292.5
                      ? (i.up = !0)
                      : (292.5 < t && t <= 337.5 && (i.up = !0), (i.right = !0));
                }
                return i;
              })(this.angle, this.dirMode, !0);
              for (var s in r) this.setKeyState(s, r[s]);
              return this;
            },
          },
          {
    ...
    _ = (function () {
      ...
      function u(t, e) {
        ...
        var n = t.scene;
        i = o.call(this, n, e);
        var r = E(e, 'eventEmitter', void 0),
          s = E(e, 'EventEmitterClass', void 0);
        return (
          i.setEventEmitter(r, s),
          (i.scene = n),
          (i.mainCamera = n.cameras.main),
          (i.pointer = void 0),
          (i.gameObject = t),
          (i.radius = E(e, 'radius', 100)),
          t.setInteractive(new k(t.displayOriginX, t.displayOriginY, i.radius), K),
          i.boot(),
          i
        );
      }
        ...
        t(u, [
          {
            key: 'resetFromJSON',
            value: function (t) {
              return r(a(u.prototype), 'resetFromJSON', this).call(this, t), (this.pointer = void 0), this;
            },
          },
          {
            key: 'toJSON',
            value: function () {
              var t = r(a(u.prototype), 'toJSON', this).call(this);
          ...
          },
          {
            ...
            value: function () {
              this.scene &&
                ...
                r(a(u.prototype), 'shutdown', this).call(this));
            },
          },
          {
            key: 'destroy',
          ...
          },
          {
            key: 'onKeyDownStart',
            value: function (t) {
              t.isDown && void 0 === this.pointer && ((this.pointer = t), this.onKeyDown(t));
            },
          },
          {
            key: 'onKeyDown',
              ...
              if (this.pointer === t) {
                ...
                if (e) {
                  var i = this.gameObject,
                    n = this.end;
                  e !== this.mainCamera ? e.getWorldPoint(t.x, t.y, n) : ((n.x = t.worldX), (n.y = t.worldY)),
                    this.setVector(i.x + e.scrollX, i.y + e.scrollY, n.x, n.y),
                    this.emit('update');
                }
              }
            },
          },
          {
            key: 'onKeyUp',
            value: function (t) {
              this.pointer === t && ((this.pointer = void 0), this.clearVector(), this.emit('update'));
            },
          },
        ]),
        u
          ...
          },
          {
            ...
            value: function (t, e) {
              return (
                ...
                void 0 === t && (t = this.scene.add.circle(0, 0, this.radius).setStrokeStyle(3, 255)),
          ...
          },
          {
            ...
            value: function (t) {
              return (
                ...
                void 0 === t && (t = this.scene.add.circle(0, 0, 40).setStrokeStyle(3, 65280)),
                (this.thumb = t),
                this
              );
            },
            ...
            value: function () {
              ...
              if (t.anyKeyDown)
                if (t.force > this.radius) {
                  var n = t.rotation;
                  (e += Math.cos(n) * this.radius), (i += Math.sin(n) * this.radius);
  ...
  return (
    Object.assign(C.prototype, g),
    (function () {
      s(i, Phaser.Plugins.BasePlugin);
      var e = c(i);
      function i(t) {
        return h(this, i), e.call(this, t);
      }
      return (
        t(i, [
          {
