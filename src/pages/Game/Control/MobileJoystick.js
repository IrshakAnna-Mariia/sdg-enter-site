...
export default class JoyStick extends Phaser.Scene {
  ...
  movePlayer() {
    ...
    if (this.lastCursorDirection == 'up') {
      ...
      if (!self.faune.anims.isPlaying) self.faune.anims.play('faune-run-up', true);
      ...
      if (!self.faune.anims.isPlaying) self.faune.anims.play('faune-run-side', true);
